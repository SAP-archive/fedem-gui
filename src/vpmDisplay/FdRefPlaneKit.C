...
SO_KIT_SOURCE(FdRefPlaneKit); 

void FdRefPlaneKit::init()
{
   SO_KIT_INIT_CLASS(FdRefPlaneKit, SoBaseKit, "BaseKit");
} 

FdRefPlaneKit::FdRefPlaneKit()
{
   SO_KIT_CONSTRUCTOR(FdRefPlaneKit); 
   isBuiltIn = TRUE;
