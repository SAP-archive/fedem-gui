...
# NOTE: This is a modified version of the same file which comes with cmake 3.17
# and facilitates that Qt can be located through environment variable QT_ROOT.
...
# KMO change 07.12.22: ${CMAKE_CURRENT_LIST_DIR} --> ${CMAKE_ROOT}/Modules
include(${CMAKE_ROOT}/Modules/CheckCXXSymbolExists.cmake)
include(${CMAKE_ROOT}/Modules/MacroAddFileDependencies.cmake)
...
function(_QT4_QUERY_QMAKE VAR RESULT)
  # KMO change 07.12.22: Use env QT_ROOT for some variables
  set(return_code 0)
  if(${VAR} STREQUAL "QT_INSTALL_HEADERS")
    set(output "$ENV{QT_ROOT}\\include")
  elseif(${VAR} STREQUAL "QT_INSTALL_LIBS")
    set(output "$ENV{QT_ROOT}\\lib")
  elseif (${VAR} STREQUAL "QT_INSTALL_BINS")
    set(output "$ENV{QT_ROOT}\\bin")
  else()
...
if (QT_QMAKE_EXECUTABLE AND
  ...
  # KMO change 07.12.22: Use CMAKE_ROOT directly instead of CMAKE_CURRENT_LIST_FILE
  set(_qt4_current_dir "${CMAKE_ROOT}/Modules")
  # end KMO change
